...
export default function ProductDetails({ params }) {
  ...
  const allProducts = [
    { id: 1, title: "Vintage Jacket", category: "Clothes", price: 1200, image: "/placeholder-image.svg", description: "A stylish vintage leather jacket in excellent condition. This jacket has been carefully maintained and shows minimal signs of wear. Perfect for casual outings and adds a classic touch to any wardrobe. The leather is soft and supple, with original hardware intact." },
    { id: 2, title: "Smartphone X", category: "Electronics", price: 8000, image: "/placeholder-image.svg", description: "Latest smartphone with advanced features and great camera quality. This device comes with original packaging and accessories. Features include high-resolution display, long-lasting battery, and cutting-edge processor for smooth performance." },
    { id: 3, title: "Wooden Chair", category: "Furniture", price: 2000, image: "/placeholder-image.svg", description: "Handcrafted wooden chair perfect for any home decor. Made from solid oak wood with excellent craftsmanship. The chair features ergonomic design for comfort and durability. Ideal for dining room, study, or office use." },
    { id: 4, title: "Designer Handbag", category: "Clothes", price: 1500, image: "/placeholder-image.svg", description: "Elegant designer handbag in premium leather. This authentic piece features multiple compartments for organization and comes with authenticity certificate. Perfect for both casual and formal occasions." },
    { id: 5, title: "Gaming Laptop", category: "Electronics", price: 45000, image: "/placeholder-image.svg", description: "High-performance gaming laptop with latest graphics card. Equipped with powerful processor, ample RAM, and fast SSD storage. Perfect for gaming, video editing, and intensive computing tasks." },
    { id: 6, title: "Coffee Table", category: "Furniture", price: 3500, image: "/placeholder-image.svg", description: "Modern glass coffee table for your living room. Features tempered glass top with sturdy metal legs. Easy to clean and adds contemporary elegance to any space." },
    // Seller listings
